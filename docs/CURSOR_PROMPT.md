...
**Endless:** infinite waves; live compose **without** pausing; wave-start checkpoint + Continue; starts 9×8 and grows south every 5 waves (cap 22 rows); pan/scroll the board; pinch (or ⌘/Ctrl+scroll) to zoom; in-game Pitch slider for foreshortening; base start **5 lives / 75 Coin**; no pre-walls; Forge/Aether meta not mid-run.
