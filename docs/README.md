...
| File | Role |
|------|------|
| [GDD.md](GDD.md) | Human design bible — locked systems (THIS iteration) |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Implemented pipelines (sim / paint / audio) |
| [DESIGN.md](DESIGN.md) | Identity, copy, dialogs, Forge UX — steps 1–4 done, step 5 (identity pass) pending |
